...
import { EventItem, CONFIG, BannerItem } from "./data";
...
export default function PrintLayout({ scale, lastUpdated, venues, events, categoryColors, config, banners }: PrintLayoutProps) {
    return (
            ...
            >
                <div className="print-structure-wrapper" style={{
                    ...
                    <div className="print-scroll-container">
                        ...
                        <PrintOverlay venues={venues} events={events} categoryColors={categoryColors} config={config} banners={banners} />
                    </div>
