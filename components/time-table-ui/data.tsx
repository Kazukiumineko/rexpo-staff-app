...
// ▼ 設定定数（レイアウト調整用）
export const CONFIG = {
    START_HOUR: 8 + 20 / 60,       // 8:20開始
    END_HOUR: 19 + 10 / 60,      // 19:10終了
    HOUR_HEIGHT: 420,    // 1時間あたりの高さ(px) - 縦長に
    HEADER_HEIGHT: 60,   // ヘッダーの高さ
    COLUMN_WIDTH: 200,   // 各会場カラムの幅
    TIME_COL_WIDTH: 60,  // 時間軸カラムの幅
    GRID_INTERVAL: 10,   // グリッドの間隔(分)
};
...
export const banners: BannerItem[] = [
    { start: "08:20", end: "08:30", text: "関係者入場 8:30" },
    { start: "09:00", end: "09:10", text: "生徒入場 9:00" },
    { start: "09:50", end: "10:00", text: "一般入場開始 10:00" },
    { start: "10:20", end: "10:30", text: "一般公開開始 10:30" },
    { start: "16:30", end: "16:40", text: "一般公開終了 16:30" }
];
